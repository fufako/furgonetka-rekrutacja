...
const Delivery = () => (
  <section class="delivery">
    ...
    <p className="delivery__description">
      Jeśli zależy Ci na czasie, możesz przyspieszyć transport zleconej paczki.
      Z Furgonetką nadasz najszybsze przesyłki krajowe. Wystarczy, że dobierzesz
      odpowiednią usługę dodatkową w zależności od przewoźnika:
    </p>
...
const DeliveryOption = ({ text, couriers }) => (
  <div className="delivery__option">
    <img src={CheckMark} alt="check-mark" className="delivery__option-image" />
